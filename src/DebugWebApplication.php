...
class DebugWebApplication extends WebApplication
{
    ...
    protected function doExecute(): void
    {
        ...
        $logger->info("DebugWebApplication doExecute called");
        $route = $this->router->parseRoute($this->get('uri.route'), $this->input->getMethod());
        $logger->debug(" result of controllerResolver->resolve(\$route)",[$this->controllerResolver->resolve($route)]);
